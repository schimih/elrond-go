...
require (
	...
	github.com/ElrondNetwork/arwen-wasm-vm/v1_4 v1.4.10
...
replace github.com/ElrondNetwork/arwen-wasm-vm/v1_4 v1.4.10 => github.com/ElrondNetwork/arwen-wasm-vm v1.4.10
